...
- PR descriptions should be objective, describing what changed and its impact, without inferring the intent behind the code. See `docs/issue-pr-guide.md` for templates.
